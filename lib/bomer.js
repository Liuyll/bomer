(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.bomer = {}));
    ...
    const getHandler = () => {
        return {
            get(target, key) {
                ...
                if (key === MODIFYCHAIN)
                    return target.inModifyChain;
                if (key === DELETE)
                    return target.deletes;
                let value = getSource(target, key);
                if (Array.isArray(value) || Object.prototype.toString.call(value) === '[object Object]') {
                    if (target.scope[key])
                        return target.scope[key];
            ...
            set(target, key, val) {
                ...
                if (key === BASE)
                    throw new Error("Error: base can't change");
                if (getSource(target, key) === val)
                    return true;
                if (!target.isChanged)
                    markChanged(target);
            ...
            deleteProperty(target, key) {
                if (!target.deletes)
                    target.deletes = [];
                if (!target.base.hasOwnProperty(key))
                    return true;
    ...
    function createProxy(state, parent) {
        const proxyState = {
            base: state,
            copy: null,
            isChanged: false,
    ...
    const isProxyableObject = (target) => {
    ...
    function finalize(state) {
        let isModify;
        if (state[COPY] || state[DELETE])
            isModify = true;
        if (!isModify && state[MODIFYCHAIN])
            isModify = true;
        ...
        if (isModify) {
            if (Array.isArray(state[BASE])) {
                ...
                switch (Object.prototype.toString.call(state[BASE])) {
                    case '[object Object]':
                        newCopy = Object.assign(Object.assign({}, state[BASE]), state[COPY]);
                        break;
                    case '[object Map]':
                        newCopy = new Map();
                        state[BASE].forEach((val, key) => {
                            newCopy.set(key, val);
                            for (let key in state[COPY]) {
                                newCopy.set(key, state[COPY][key]);
                            }
                        });
                }
            }
            if (state[DELETE]) {
                state[DELETE].forEach(key => {
                    delete newCopy[key];
                });
            }
        }
        ...
        if (isModify) {
            if (Array.isArray(newCopy) || Object.prototype.toString.call(newCopy) === '[object Object]') {
                ...
                if (newCopy instanceof Map) {
                    for (let [key, val] of newCopy) {
                        if (isProxyableObject(val)) {
                            newCopy.set(key, finalize(state[STATE].scope[key]));
                        }
                    }
                }
                // TODO: set
    ...
    function produce(state, recipe, action) {
        if (typeof state !== 'function') {
            if (typeof recipe !== 'function')
                throw new Error();
            let bomerProxy = createProxy(state, null);
            if (action) {
            ...
            // curried produce
            let realState = recipe;
            let realRecipe = state;
            return (action) => {
    ...
    */
    ...
    var D__code_js_bomer_node_modules_objectAssign = shouldUseNative() ? Object.assign : function (target, source) {
      var from;
    ...
    F.constructor = E;
    D__code_js_bomer_node_modules_objectAssign(F, C.prototype);
    ...
    var T = {
      ...
      assign: D__code_js_bomer_node_modules_objectAssign
    };
    exports.Children = {
      map: P,
    ...
    exports.cloneElement = function (a, b, c) {
      ...
      var e = D__code_js_bomer_node_modules_objectAssign({}, a.props),
          d = a.key,
          k = a.ref,
          h = a._owner;
    ...
    if (process.env.NODE_ENV !== "production") {
      (function () {
        ...
        var _assign = D__code_js_bomer_node_modules_objectAssign; // TODO: this is special because it gets imported during build.
    ...
    var D__code_js_bomer_node_modules_react = createCommonjsModule(function (module) {
    ...
    D__code_js_bomer_node_modules_react.Fragment;
    D__code_js_bomer_node_modules_react.StrictMode;
    D__code_js_bomer_node_modules_react.Profiler;
    D__code_js_bomer_node_modules_react.Suspense;
    D__code_js_bomer_node_modules_react.Children;
    D__code_js_bomer_node_modules_react.Component;
    D__code_js_bomer_node_modules_react.PureComponent;
    D__code_js_bomer_node_modules_react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    D__code_js_bomer_node_modules_react.cloneElement;
    D__code_js_bomer_node_modules_react.createContext;
    D__code_js_bomer_node_modules_react.createElement;
    D__code_js_bomer_node_modules_react.createFactory;
    D__code_js_bomer_node_modules_react.createRef;
    D__code_js_bomer_node_modules_react.forwardRef;
    D__code_js_bomer_node_modules_react.isValidElement;
    D__code_js_bomer_node_modules_react.lazy;
    D__code_js_bomer_node_modules_react.memo;
    var D__code_js_bomer_node_modules_react_18 = D__code_js_bomer_node_modules_react.useCallback;
    D__code_js_bomer_node_modules_react.useContext;
    D__code_js_bomer_node_modules_react.useDebugValue;
    D__code_js_bomer_node_modules_react.useEffect;
    D__code_js_bomer_node_modules_react.useImperativeHandle;
    D__code_js_bomer_node_modules_react.useLayoutEffect;
    D__code_js_bomer_node_modules_react.useMemo;
    D__code_js_bomer_node_modules_react.useReducer;
    D__code_js_bomer_node_modules_react.useRef;
    var D__code_js_bomer_node_modules_react_27 = D__code_js_bomer_node_modules_react.useState;
    D__code_js_bomer_node_modules_react.version;

    const useImmutable = (state) => {
        const [store, setStore] = D__code_js_bomer_node_modules_react_27(state);
        const mutable = D__code_js_bomer_node_modules_react_18((recipe) => {
